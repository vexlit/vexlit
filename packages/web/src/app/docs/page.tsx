...
const COMMANDS = [
  ...
  {
    command: "vexlit scan src/ lib/utils.ts",
    description: "Scan specific files or directories",
  },
  {
    command: "vexlit scan . --json",
    description: "Output results as JSON",
  },
  {
    command: "vexlit scan . --sarif > results.sarif",
    description: "Export SARIF for GitHub Security tab",
  },
  {
    command: "vexlit scan . --llm --api-key sk-ant-...",
    description: "Enable AI-powered verification with Claude",
  },
];
...
const OUTPUT_LINES = [
  ...
  { type: "blank" as const, text: "" },
  {
    ...
    text: "CRITICAL  VEXLIT-002  SQL Injection           api/users.js:42",
  },
  {
    type: "critical" as const,
    text: "CRITICAL  VEXLIT-001  Hardcoded Secret        config/auth.ts:12",
  },
  {
    type: "warning" as const,
    text: "WARNING   VEXLIT-012  SSRF                    lib/fetch.ts:28",
  },
  {
    type: "info" as const,
    text: "INFO      VEXLIT-019  Debugger Statement      utils/debug.js:5",
  },
  { type: "blank" as const, text: "" },
  {
    type: "summary" as const,
    text: "Found 4 vulnerabilities (2 critical, 1 warning, 1 info)",
  },
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-28 pb-12">
        ...
        <h1 className="text-4xl md:text-5xl font-bold leading-tight tracking-tight mb-4">
          Scan your code from the{" "}
          <span className="bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent">
            command line
          </span>
        </h1>
        <p className="text-lg text-gray-400 max-w-2xl mb-8">
          Install the VEXLIT CLI to scan locally, in CI/CD pipelines, or
          anywhere Node.js runs. 85+ SAST rules, 200+ secret detectors, zero
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 border-t border-gray-800">
        <SectionHeading
          ...
          description="Install globally with npm, or use npx to run without installing."
        />
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 border-t border-gray-800">
        <SectionHeading
          badge="02 Commands"
          title="Simple, powerful scanning"
          description="One command to scan. Flags to customize output format and behavior."
        />
        <div className="space-y-3">
          {COMMANDS.map((c) => (
            <div
              key={c.command}
              className="bg-gray-900 border border-gray-800 rounded-xl px-5 py-4 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 hover:border-gray-700 transition-colors"
            >
              <code className="text-green-400 text-sm font-mono whitespace-nowrap flex-shrink-0">
                $ {c.command}
              </code>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 border-t border-gray-800">
        <SectionHeading
          ...
          description="Findings are grouped by severity with file location and rule ID."
        />
        <TerminalOutput />
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 border-t border-gray-800">
        <SectionHeading
          ...
          description="Create a vexlit.config.js to disable rules, override severity, or ignore paths."
        />
        <CodeBlock
          code={CONFIG_EXAMPLE}
          lang="js"
          filename="vexlit.config.js"
        />
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 border-t border-gray-800">
        <SectionHeading
          ...
          description="Add security scanning to your CI pipeline. SARIF results appear in the GitHub Security tab."
        />
        <CodeBlock
          code={GITHUB_ACTION}
          lang="yaml"
        ...
        <div className="mt-6 grid sm:grid-cols-2 gap-4">
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
            <p className="text-white text-sm font-medium mb-3">Inputs</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <code className="text-gray-400 font-mono">paths</code>
                <span className="text-gray-600">.</span>
              </div>
              <div className="flex justify-between">
                <code className="text-gray-400 font-mono">format</code>
                <span className="text-gray-600">sarif</span>
              </div>
              <div className="flex justify-between">
                <code className="text-gray-400 font-mono">fail-on</code>
                <span className="text-gray-600">critical</span>
              </div>
              <div className="flex justify-between">
                <code className="text-gray-400 font-mono">upload-sarif</code>
                <span className="text-gray-600">true</span>
              </div>
            </div>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
            <p className="text-white text-sm font-medium mb-3">Outputs</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <code className="text-gray-400 font-mono">total</code>
                <span className="text-gray-600">Total vulnerabilities</span>
              </div>
              <div className="flex justify-between">
                <code className="text-gray-400 font-mono">critical</code>
                <span className="text-gray-600">Critical count</span>
              </div>
              <div className="flex justify-between">
                <code className="text-gray-400 font-mono">sarif-file</code>
                <span className="text-gray-600">SARIF output path</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 border-t border-gray-800">
        <SectionHeading
          ...
          description="Import the core engine directly in your Node.js scripts or tools."
        />
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 border-t border-gray-800">
        <div className="bg-gradient-to-br from-red-500/10 to-orange-500/10 border border-red-500/20 rounded-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-gray-400 max-w-lg mx-auto mb-8">
            Start scanning in seconds. No sign-up required for the CLI.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/login"
              className="px-6 py-3 bg-red-600 rounded-lg font-medium text-sm hover:bg-red-700 transition-colors"
            >
              Try Web Dashboard
            </Link>
          </div>
